...
--------------------
🧭 How It Fits
Your master PowerShell script calls this proc for each Lake_* table.

Each run moves a batch of unprocessed XML into the relational schema.

Metrics at the end confirm how many sessions, players, hands, etc. are now in the system.
*/